...
<html>
    <head>
        <title>Mangage Employee Login</title>
		...
		<div class="wrapper">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					<!--
					<form class="register" action="../authentication.php?q=register" method="post">
						<h3>Register</h3>
					...
					-->
					<form class="login active" action="../authentication.php?q=login<?php if(array_key_exists('return',$_GET)) echo "&return=" . $_GET['return'];?>" method="post">
						<h3>Login</h3>
						<div>
							<label>Username:</label>
